...
Vynikám analytickým myslením, znalosťou algoritmov, dátových štruktúr a design patternov, čo mi umožňuje rýchlu adaptáciu na nové technológie. Dbám na čistý a optimalizovaný kód a rád prejavujem kreativitu pri riešení problémov. Napriek dysgrafii a dyslexii efektívne plním svoje úlohy a pri riešení problémov dokážem myslieť do hĺbky a prichádzať s riešeniami z iného pohľadu.
